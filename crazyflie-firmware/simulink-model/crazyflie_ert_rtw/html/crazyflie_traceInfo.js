function RTW_rtwnameSIDMap() {
	...
	this.rtwnameHashMap["<Root>/Dist_1"] = {sid: "crazyflie:421"};
	this.sidHashMap["crazyflie:421"] = {rtwname: "<Root>/Dist_1"};
	this.rtwnameHashMap["<Root>/Dist_2"] = {sid: "crazyflie:422"};
	this.sidHashMap["crazyflie:422"] = {rtwname: "<Root>/Dist_2"};
	this.rtwnameHashMap["<Root>/Dist_3"] = {sid: "crazyflie:423"};
	this.sidHashMap["crazyflie:423"] = {rtwname: "<Root>/Dist_3"};
	this.rtwnameHashMap["<Root>/Dist_4"] = {sid: "crazyflie:424"};
	this.sidHashMap["crazyflie:424"] = {rtwname: "<Root>/Dist_4"};
	this.rtwnameHashMap["<Root>/Dist_5"] = {sid: "crazyflie:425"};
	this.sidHashMap["crazyflie:425"] = {rtwname: "<Root>/Dist_5"};
