function CodeDefine() { 
this.def = new Array();
this.def["rtU"] = {file: "crazyflie_c.html",line:25,type:"var"};
this.def["rtY"] = {file: "crazyflie_c.html",line:28,type:"var"};
this.def["crazyflie_step"] = {file: "crazyflie_c.html",line:31,type:"fcn"};
this.def["crazyflie_initialize"] = {file: "crazyflie_c.html",line:55,type:"fcn"};
this.def["crazyflie_terminate"] = {file: "crazyflie_c.html",line:67,type:"fcn"};
this.def["ExtU"] = {file: "crazyflie_h.html",line:48,type:"type"};
this.def["ExtY"] = {file: "crazyflie_h.html",line:62,type:"type"};
...
this.def["isInit"] = {file: "crazyflieModel_c.html",line:43,type:"var"};
this.def["sensorData"] = {file: "crazyflieModel_c.html",line:44,type:"var"};
this.def["setpoint"] = {file: "crazyflieModel_c.html",line:45,type:"var"};
this.def["state"] = {file: "crazyflieModel_c.html",line:46,type:"var"};
this.def["l6"] = {file: "crazyflieModel_c.html",line:47,type:"var"};
this.def["m4"] = {file: "crazyflieModel_c.html",line:48,type:"var"};
this.def["distDataQueue"] = {file: "crazyflieModel_c.html",line:51,type:"var"};
this.def["crazyflieModelEnqueueDistance"] = {file: "crazyflieModel_c.html",line:55,type:"fcn"};
this.def["hasDistanceMeasurement"] = {file: "crazyflieModel_c.html",line:69,type:"fcn"};
this.def["acquireLPSData"] = {file: "crazyflieModel_c.html",line:74,type:"fcn"};
this.def["crazyflieModelInit"] = {file: "crazyflieModel_c.html",line:88,type:"fcn"};
this.def["crazyflieModelTest"] = {file: "crazyflieModel_c.html",line:110,type:"fcn"};
this.def["crazyflieModelTask"] = {file: "crazyflieModel_c.html",line:119,type:"fcn"};
}
